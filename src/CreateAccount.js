          ...
          <Text color = "#AAAAAA">Patient's registration form:</Text>
            <Form
              ...
              onSubmit={({ value }) => {
                ...
                fetch("https://regent-hms-group-11.onrender.com/checkIfPatientExists?email=" + value.email)
                  .then(res => res.json())
                  .then(res => {
                    ...
                    if ((res.data[0])) {
                      ...
                      fetch("https://regent-hms-group-11.onrender.com/makeAccount?name=" + value.firstName + "&lastname=" + value.lastName + "&doctor_id=" + value.doctor_id
                        + "&email=" + value.email + "&password=" + value.password + "&address=" + value.address + "&sex=" + value.sex
