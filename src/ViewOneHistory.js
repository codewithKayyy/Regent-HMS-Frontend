...
export class ViewOneHistory extends Component {
    ...
    getHistory(value) {
        let email = "'" + value + "'";
        fetch('https://regent-hms-group-11.onrender.com/OneHistory?patientEmail='+ email)
        .then(res => res.json())
    ...
    allDiagnoses(value) {
        let email = "'" + value + "'";
        fetch('https://regent-hms-group-11.onrender.com/allDiagnoses?patientEmail='+ email)
        .then(res => res.json())
