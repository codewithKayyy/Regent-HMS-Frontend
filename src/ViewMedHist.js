...
export class ViewMedHist extends Component {
    ...
    getNames(value) {
        ...
        if (value !== undefined)
            patName = value;
        console.log(patName);
        fetch('https://regent-hms-group-11.onrender.com/MedHistView?name='+ patName + '&variable=words')
        .then(res => res.json())
    ...
    render() {
        ...
        const Header = () => (
            <Box
                ...
                flex={false}
            >
               <a style={{ color: 'inherit', textDecoration: 'inherit'}} href="/"><Heading level='3' margin='none'>Regent Hospital Management Systems</Heading></a>
